      ...
      aws.putLogEvents(payload, function(err, data) {
        ...
        if (err) {
          if (err.name === 'ResourceNotFoundException') {
            debug('ResourceNotFoundException, ensuring log group and stream are present');
            return lib.ensureLogGroupAndStream(aws, groupName, streamName, retentionInDays, options, () => {
...
lib.ensureLogGroupAndStream = function(aws, groupName, streamName, retentionInDays, options, cb) {
